...
export const registerUser = async (email, password, role, companyId = null) => {
    ...
    console.log(`AuthService: Attempting to register user ${email} with role ${role} for company ${companyId || 'N/A'}`);
    ...
    try {
        ...
        // Let's try updating the public.users table directly after creation.
